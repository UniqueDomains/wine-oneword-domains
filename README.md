# Available .WINE One-Word Domains (5,622,103)

<p align="left">
  <img alt="status" src="https://img.shields.io/badge/status-active-2ea44f">
  <img alt="updated" src="https://img.shields.io/badge/updated-daily-0969da">
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-8%2C952%20rows-8250df">
...
> **Important:** this repository is a **public 8,952-row extract**, not the full live catalog.
> The full live catalog for this exact search currently contains **5,622,103 domains** on the canonical page below.

**Public extract:** 8,952 rows · **Live catalog:** 5,622,103 domains
...
- `wine.csv` — public CSV extract (8,952 rows)
- `wine.json` — public JSON extract (8,952 rows)
...
| gold.wine    | premium   | $520      | $520          | 72             | 49     | 4      | namecheap                                           |
...
| health.wine  | premium   | $85.80    | $85.80        | 92             | 45     | 6      | namecheap                                           |
| creator.wine | available | $9.99     | $77.99        | 70             | 44     | 7      | name.com                                            |
| home.wine    | resell    | —         | —             | 100            | 62     | 4      | 1API GmbH                                           |
| first.wine   | premium   | $82.50    | $82.50        | 80             | 42     | 5      | name.com                                            |
| agile.wine   | available | $9.99     | $77.99        | 92             | 42     | 5      | name.com                                            |
| search.wine  | resell    | —         | —             | 70             | 57     | 6      | Dynadot Inc                                         |
| sales.wine   | premium   | $520      | $520          | 66             | 41     | 5      | namecheap                                           |
| unity.wine   | available | $9.99     | $77.99        | 70             | 41     | 5      | name.com                                            |
...
| ----------------------- | ------------------------------------------------ |
| 8,952-row public sample | 5,622,103 live domains                           |
...
> Unique Domains. *Available .WINE One-Word Domains*. Version 2026-04-10. Public GitHub extract for the exact Unique Domains search represented by this repository.
